...
#         gesture = CustomString()
#         gesture.data = ""+gesture
#         gesture.header = Header()
...
#     def capture_rgb():
#         rgb = CustomString()
#         rgb.data = image_generator.get_raw_image_map_bgr()
#         rgb.header = Header()
#         rgb.header.stamp = rospy.Time.now()
#         rgb_pub.publish(rgb)
#         frame = np.fromstring(rgb.data, dtype=np.uint8).reshape(480, 640, 3)
#         try:
#             img = bridge.cv2_to_imgmsg(frame, "bgr8")
#             img.header = Header()
#             img.header.stamp = rospy.Time.now()
#             rgb_pub2.publish(img)
...
#                     skeleton.id = id
#                     skeleton.data = str(newpos_skeleton)
