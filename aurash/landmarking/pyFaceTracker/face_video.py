...
if __name__ == '__main__':
    ...
    args = dict(args)
    face_fn = args.get('--con', "../external/FaceTracker/model/face.tracker")
    con_fn = args.get('--con', "../external/FaceTracker/model/face.con")
    tri_fn  = args.get('--tri', "../external/FaceTracker/model/face.tri")
