...
(cl:defmethod cl:initialize-instance :after ((m <Skeleton>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Skeleton)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name skeleton-msg:<Skeleton> is deprecated: use skeleton-msg:Skeleton instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Skeleton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader skeleton-msg:id-val is deprecated.  Use skeleton-msg:id instead.")
  (id m))
