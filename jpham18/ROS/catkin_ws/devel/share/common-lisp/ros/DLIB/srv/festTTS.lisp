...
(cl:defmethod cl:initialize-instance :after ((m <festTTS-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'festTTS-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name DLIB-srv:<festTTS-request> is deprecated: use DLIB-srv:festTTS-request instead.")))

(cl:ensure-generic-function 'str-val :lambda-list '(m))
(cl:defmethod str-val ((m <festTTS-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader DLIB-srv:str-val is deprecated.  Use DLIB-srv:str instead.")
  (str m))
...
(cl:defmethod cl:initialize-instance :after ((m <festTTS-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'festTTS-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name DLIB-srv:<festTTS-response> is deprecated: use DLIB-srv:festTTS-response instead.")))
