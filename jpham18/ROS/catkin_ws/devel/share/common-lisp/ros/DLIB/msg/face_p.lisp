...
(cl:defmethod cl:initialize-instance :after ((m <face_p>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'face_p)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name DLIB-msg:<face_p> is deprecated: use DLIB-msg:face_p instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <face_p>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader DLIB-msg:header-val is deprecated.  Use DLIB-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'arr-val :lambda-list '(m))
(cl:defmethod arr-val ((m <face_p>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader DLIB-msg:arr-val is deprecated.  Use DLIB-msg:arr instead.")
  (arr m))
