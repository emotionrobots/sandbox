...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'DLIB' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/julian/sandbox/jpham18/ROS/catkin_ws/install/${idir}'.  Ask the maintainer 'aurash <aurashnorouzi@gmail.com>' to fix it.")
    endif()
